...
describe('Product e2e test', () => {
  ...
  it('should load create Product page', async () => {
    ...
    expect(await productUpdatePage.getPageTitle()).to.eq('rdlgalaxieApp.product.home.createOrEditLabel');
  ...
  it('should delete last Product', async () => {
    ...
    expect(await productDeleteDialog.getDialogTitle()).to.eq('rdlgalaxieApp.product.delete.question');
