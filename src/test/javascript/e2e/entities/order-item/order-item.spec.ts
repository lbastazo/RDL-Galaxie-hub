...
describe('OrderItem e2e test', () => {
  ...
  it('should load create OrderItem page', async () => {
    ...
    expect(await orderItemUpdatePage.getPageTitle()).to.eq('rdlgalaxieApp.orderItem.home.createOrEditLabel');
  ...
  it('should delete last OrderItem', async () => {
    ...
    expect(await orderItemDeleteDialog.getDialogTitle()).to.eq('rdlgalaxieApp.orderItem.delete.question');
