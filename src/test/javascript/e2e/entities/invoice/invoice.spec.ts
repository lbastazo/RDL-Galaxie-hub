...
describe('Invoice e2e test', () => {
  ...
  it('should load create Invoice page', async () => {
    ...
    expect(await invoiceUpdatePage.getPageTitle()).to.eq('rdlgalaxieApp.invoice.home.createOrEditLabel');
  ...
  it('should delete last Invoice', async () => {
    ...
    expect(await invoiceDeleteDialog.getDialogTitle()).to.eq('rdlgalaxieApp.invoice.delete.question');
