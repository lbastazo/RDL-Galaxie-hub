...
describe('ProductCategory e2e test', () => {
  ...
  it('should load create ProductCategory page', async () => {
    ...
    expect(await productCategoryUpdatePage.getPageTitle()).to.eq('rdlgalaxieApp.productCategory.home.createOrEditLabel');
  ...
  it('should delete last ProductCategory', async () => {
    ...
    expect(await productCategoryDeleteDialog.getDialogTitle()).to.eq('rdlgalaxieApp.productCategory.delete.question');
