...
describe('Customer e2e test', () => {
  ...
  it('should load create Customer page', async () => {
    ...
    expect(await customerUpdatePage.getPageTitle()).to.eq('rdlgalaxieApp.customer.home.createOrEditLabel');
  ...
  it('should delete last Customer', async () => {
    ...
    expect(await customerDeleteDialog.getDialogTitle()).to.eq('rdlgalaxieApp.customer.delete.question');
