...
describe('ProductOrder e2e test', () => {
  ...
  it('should load create ProductOrder page', async () => {
    ...
    expect(await productOrderUpdatePage.getPageTitle()).to.eq('rdlgalaxieApp.productOrder.home.createOrEditLabel');
  ...
  it('should delete last ProductOrder', async () => {
    ...
    expect(await productOrderDeleteDialog.getDialogTitle()).to.eq('rdlgalaxieApp.productOrder.delete.question');
