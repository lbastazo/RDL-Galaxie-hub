...
describe('Shipment e2e test', () => {
  ...
  it('should load create Shipment page', async () => {
    ...
    expect(await shipmentUpdatePage.getPageTitle()).to.eq('rdlgalaxieApp.shipment.home.createOrEditLabel');
  ...
  it('should delete last Shipment', async () => {
    ...
    expect(await shipmentDeleteDialog.getDialogTitle()).to.eq('rdlgalaxieApp.shipment.delete.question');
